...
var _feathersErrors3 = _interopRequireDefault(_feathersErrors);
  ...
  _createClass(Service, [{
    ...
    value: function update(id, data) {
      ...
      if (Array.isArray(data) || id === null) {
        return _bluebird2.default.reject(new _feathersErrors3.default.BadRequest('Not replacing multiple records. Did you mean `patch`?'));
      }
