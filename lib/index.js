...
class Service {
  ...
  _view(query, params) {
    return this.db.then(db => db.viewAsync(query.designname, query.viewname, params));
  }

  find(params = {}) {
    return (params.query ? this._view(params.query, params.params) : this._list(Object.assign({ include_docs: true }, params))).then(obj => this._return(obj)).catch(_errorHandler2.default);
  }
