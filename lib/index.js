...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    key: '_view',
    value: function _view(query, params) {
      return this.db.then(function (db) {
        return db.viewAsync(query.designname, query.viewname, params);
      });
    }
  }, {
    key: 'find',
    value: function find() {
      ...
      return (params.query ? this._view(params.query, params.params) : this._list(Object.assign({ include_docs: true }, params))).then(function (obj) {
    ...
    value: function update(id, data) {
      ...
      return this._get(id, params).then(function (doc) {
        ...
        return _this4._insert(data, id).then(function () {
          return data;
        });
      }).catch(_errorHandler2.default);
    }
    ...
    value: function patch(id, data) {
      ...
      return this._get(id, params).then(function (doc) {
        var rev = doc._rev;
        doc = _this5._return(doc);
        Object.assign(doc, { _rev: rev }, data);
        return _this5._insert(doc, id).then(function () {
          return doc;
        });
      }).catch(_errorHandler2.default);
    }
    ...
    value: function remove(id) {
      ...
      return this._get(id, params).then(function (doc) {
        return _this6._destroy(doc._id, doc._rev);
      }).catch(_errorHandler2.default);
    }
  }]);
