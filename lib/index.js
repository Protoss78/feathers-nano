...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    key: '_safeAttributes',
    value: function _safeAttributes(obj) {
      delete obj._id;
      delete obj._rev;
      return obj;
    }
    ...
    value: function _return(data) {
      ...
      var parse = function parse(obj) {
        ...
        return _this2._safeAttributes(obj);
      };
    ...
    value: function update(id, data) {
      ...
      return this._get(id, params).then(function (doc) {
        ...
        return _this6._insert(data, id).then(function () {
          return data;
        });
      }).catch(_errorHandler2.default);
    }
    ...
    value: function patch(id, data) {
      ...
      return this._get(id, params).then(function (doc) {
        var rev = doc._rev;
        doc = _this7._safeAttributes(doc);
        Object.assign(doc, { _rev: rev }, data);
        return _this7._insert(doc, id).then(function () {
    ...
    value: function remove(id) {
      ...
      return this._get(id, params).then(function (doc) {
        return _this8._destroy(doc._id, doc._rev);
      }).catch(_errorHandler2.default);
    }
  }]);
