...
class Service {
  ...
  */
  ...
  view(designname, viewname, params = {}) {
    params.limit = params.limit || this.paginate.default;
    return this._view(designname, viewname, params).then(res => {
      return {
        total: res.total_rows,
        limit: params.limit,
        skip: res.offset,
  ...
  patch(id, data, params = {}) {
    return this._get(id, params).then(doc => ((0, _util.mergeDeep)(doc, data), this._insert(doc, id).then(res => Object.assign(doc, { _rev: res.rev })))).catch(_errorHandler2.default);
  }
